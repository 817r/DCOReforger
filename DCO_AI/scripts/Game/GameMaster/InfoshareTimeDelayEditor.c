...
class DCO_AIInfoShareDelayEditorAttribute : SCR_BaseValueListEditorAttribute
{
	//------------------------------------------------------------------------------------------------
	override SCR_BaseEditorAttributeVar ReadVariable(Managed item, SCR_AttributesManagerEditorComponent manager)
	{
		...
		{
			cusRank = SCRDCO_AIConfigComponent.GetInfoshareDelay(editableEntity.GetOwner());
		}
		...
		{			
			...
			cusRank = SCRDCO_AIConfigComponent.GetInfoshareDelay(aiGroup.GetLeaderEntity());
		} else return null;
	...
	override void WriteVariable(Managed item, SCR_BaseEditorAttributeVar var, SCR_AttributesManagerEditorComponent manager, int playerID)
	{
		...
		SCRDCO_AIConfigComponent.SetInfoshareDelay(editableEntity.GetOwner(), cusRank);
