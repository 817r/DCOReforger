...
{
	protected override void SendInvestigateMessages(AICommunicationComponent comms, vector pos, float radius)
	{
		...
		{	
			...
			foreach (AIAgent agent : agents)
			{
				...
				SCR_AIMessage_Investigate msg = SCR_AIMessage_Investigate.Create(this,pos, radius * 2, true, duration: 15000);
