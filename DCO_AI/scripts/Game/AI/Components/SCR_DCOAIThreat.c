...
modded class SCR_AIThreatSystem
{
	...
	private static const float THREAT_SHOT_DROP_RATE = 	0.10 * 0.001; // Falloff (percentual drop per milisecond)
	private static const float THREAT_SUPPRESSION_DROP_RATE = 0.2 * 0.001;
	private static const float THREAT_ENDANGERED_DROP_RATE = 	0.15 * 0.001;
