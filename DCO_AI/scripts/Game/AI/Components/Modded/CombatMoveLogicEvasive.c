class SCR_AICombatMoveLogic_Evasive : SCR_AICombatMoveLogicBase
{
	// Inputs
	...
	protected float minRandomTime = 3;
	protected float maxRandomTime = 7;
	...
	protected override float ResolveStoppedWaitTime(bool inCover, EAIThreatState threat, EWeaponType weaponType)
	{
		...
		waitTime = Math.Clamp(waitTime, 5, 120);
