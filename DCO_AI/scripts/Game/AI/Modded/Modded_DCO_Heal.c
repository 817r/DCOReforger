...
{
	protected const float MAX_TIME_TO_UNCON_HIGH_PRIORITY_S = 16; // Time in seconds to losing consciousness below which we treat healing ourselves as high priority
