class DCO_AICalculateCoverQueryProps_Indoor : AITaskScripted
{
	//---------------------------------------------------------------
	// Inputs
	...
	override ENodeResult EOnTaskSimulate(AIAgent owner, float dt)
	{
		...
		query.m_bSelectHighestScore = true; // Select lowest score cover (nearest)
