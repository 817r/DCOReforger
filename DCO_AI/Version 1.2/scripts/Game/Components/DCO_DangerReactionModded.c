modded class SCR_AIDangerReaction
{
	...
	bool PerformReaction(notnull SCR_AIUtilityComponent utility, notnull SCR_AIThreatSystem threatSystem, notnull DCO_AIMoraleSystem moraleSystem, AIDangerEvent dangerEvent) {}
